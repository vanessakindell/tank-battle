...
Const RESOLUTION_DEFAULT_WIDTH  = 800
Const RESOLUTION_DEFAULT_HEIGHT = 600
Const RESOLUTION_DEFAULT_DEPTH  = 16
Const RESOLUTION_DEFAULT_MODE = 5

; This is the command line..
Global sCL$ = Upper(CommandLine())

; Find the screen mode...
iScrType = bblGetOption("TYPE",Str(RESOLUTION_DEFAULT_MODE))
Select iScrType
	Case 1
		iScreenMode = 3
		HidePointer()
